...
class Game:
	...
	def __init__(self, numGhosts, width,height):
		...
		self.ghosts=[Ghost() for i in range(self.NUM_GHOSTS)] #initialize ghosts
		...
		for ghost in self.ghosts:
			ghost.setPosition(18,18) # set starting positions, may have to split this up to assign different starting locations to each
